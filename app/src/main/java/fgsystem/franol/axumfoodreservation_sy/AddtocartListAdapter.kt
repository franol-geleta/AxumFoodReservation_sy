...
class AddtocartListAdapter(context: Context):RecyclerView.Adapter<AddtocartListAdapter.AddtoCartViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddtocartListAdapter.AddtoCartViewHolder {
    ...
    override fun onBindViewHolder(holder: AddtocartListAdapter.AddtoCartViewHolder, position: Int) {
